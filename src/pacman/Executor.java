...
import pacman.controllers.Mohamed_Rizwan.*;
...
//		exec.runGameTimed(new StarterPacMan(),new StarterGhosts(),visual);
		...
		//exec.runGameTimed(new BFSController(),new StarterGhosts(),visual);
		//exec.runGameTimed(new DFSController(),new StarterGhosts(),visual);
		//exec.runGameTimed(new IterativeDeepeningController(),new StarterGhosts(),visual);
		
		//Assignment2
		//exec.runGameTimed(new AStarController(),new StarterGhosts(),visual);
		//exec.runGameTimed(new HillClimberController(),new StarterGhosts(),visual);
		//exec.runGameTimed(new SimulatedAnnealingController(),new StarterGhosts(),visual);
			
		//Assignment 3
		//exec.runGameTimed(new EvolutionController(),new StarterGhosts(),visual);
		//exec.runGameTimed(new GeneticController(),new StarterGhosts(),visual);
		//exec.runGameTimed(new AlphaBetaController(Executor.ghostAI),new StarterGhosts(),visual);
		//*/
		
		//Assignment 4
		//exec.runGameTimed(new KNearestNeighbourController(),new StarterGhosts(),visual);
		//exec.runGameTimed(new PerceptronController(),new StarterGhosts(),visual);
		//exec.runGameTimed(new QLearningController(),new StarterGhosts(),visual);
		
		//Project
		//exec.runGameTimed(new MyPacManController(),new StarterGhosts(),visual);
